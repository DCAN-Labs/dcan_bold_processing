function postreg_fig_fMRI_QA(fMRIName,nan_FD, Xd, nan_DVAR_pre_reg, nan_DVAR_post_reg, nan_DVAR_post_all,path_ex_sum)
...
set(gca,'xticklabel',[]);
axis off
png_file=[path_ex_sum '/postreg_DVARS_and_FD_' fMRIName '.png'];
