...
function logical_removal_vector = power_2014_FD_only_censoring(FD_vector,FD_threshold,skip,expected_contiguous_frame_count)

% Caluclate and combine the FD and DVAR removal vectors
FD_removal_vector = censor(FD_vector,FD_threshold);

logical_removal_vector = contiguous_frame_censor(FD_removal_vector,expected_contiguous_frame_count);
