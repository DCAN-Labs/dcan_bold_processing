...
[subjectList, subjectSurvival, missing_subjects] = power_motion_survival_plot(group_folder_path,subject_list_file);

%% Changing figure properties

set(gca,'ytick',1:length(subjectList),'yticklabel',subjectList);
