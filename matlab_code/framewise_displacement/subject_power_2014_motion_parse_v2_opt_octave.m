function subject_power_2014_motion_parse_v2_opt_octave(movement_files,skip_seconds,epi_TR,expected_contiguous_frame_count,output_dir)
...
save([output_dir '/power_2014_motion.mat'],'motion_data','-v7');
