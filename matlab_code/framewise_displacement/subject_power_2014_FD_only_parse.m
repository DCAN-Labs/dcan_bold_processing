function subject_power_2014_FD_only_parse(movement_files,skip_seconds,epi_TR,expected_contiguous_frame_count,output_dir)
...
%this_path=pwd;
save([output_dir filesep 'power_2014_FD_only.mat'],'motion_data');
